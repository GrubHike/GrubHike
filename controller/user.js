...
exports.signupController = async(req,res,next) => {
    ...
    if(req.body.userName && req.body.email && req.body.phoneNum && req.body.dob && req.body.firstName && req.body.lastName && req.body.gender)
    {
     ...
     //console.log(id);
        User.findOneAndUpdate({_id:id},{
            $set : {
               ...
               cityOrVillage : req.body.cityOrVillage
            }
        }).exec().then(
            //If Updated Successfully then trying to get new updated data
                result=>{
